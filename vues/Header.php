...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color: whitesmoke;">
  <a class="navbar-brand" href="index.php"> <img src="Images/logoComToBaleze.png" width="40px"> &nbsp; ComTO &nbsp; <img src="Images/logoComToBaleze.png" width="40px"> </a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">Listes des TO</a>
      </li>
    </ul>
  </div>
</nav>
